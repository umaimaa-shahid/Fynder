            ...
            <div key={m._id} style={{
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11, color: '#64748B', marginBottom: 6 }}>{m.studentId}</div>
          ...
          {recentRequests.map((r, i) => (
            <div key={r._id} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ width: 34, height: 34, borderRadius: '50%', background: AVATAR_COLORS[i % AVATAR_COLORS.length], display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 700, color: '#fff' }}>
